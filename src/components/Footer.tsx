              ...
              <div className="flex gap-3">
                {socialLinks.map((social) => (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    className={`p-3 bg-white/10 backdrop-blur-sm rounded-xl ${social.color} transition-all hover:bg-white/20 group`}
                    title={social.name}
                  >
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3 text-gray-400 hover:text-white transition-colors group">
                ...
                <div>
                  ...
                  <a href={`mailto:${settings?.email || 'info@refresh-cafe.ly'}`} className="hover:underline">
