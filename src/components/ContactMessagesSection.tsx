...
⏰ ${new Date().toLocaleString('ar-LY')}
  ...
  return (
    <section id="contact" className="relative py-20 overflow-hidden bg-gradient-to-b from-gray-50 via-white to-gray-50">
      {/* Animated Background */}
      ...
      <div className="container-custom relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="lg:col-span-2 space-y-4">
            {contactInfo.map((item, index) => (
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
                className={`block p-6 rounded-3xl ${item.bgLight} hover:shadow-2xl transition-all duration-300 group cursor-pointer border-2 border-transparent hover:border-white`}
              >
                <div className="flex items-center gap-4">
                  <div className={`p-4 bg-gradient-to-br ${item.color} rounded-2xl shadow-lg group-hover:scale-110 transition-transform`}>
          ...
          >
            <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-10 border-2 border-gray-100 relative overflow-hidden">
              {/* Decorative gradient */}
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="group">
                  ...
                  <input
                    ...
                    className="w-full px-6 py-4 bg-gray-50 border-2 border-gray-200 rounded-2xl focus:bg-white focus:ring-4 focus:ring-purple-500/20 focus:border-purple-500 transition-all text-lg placeholder:text-gray-400"
                ...
                <div className="group">
                  ...
                  <textarea
                    ...
                    className="w-full px-6 py-4 bg-gray-50 border-2 border-gray-200 rounded-2xl focus:bg-white focus:ring-4 focus:ring-purple-500/20 focus:border-purple-500 transition-all resize-none text-lg placeholder:text-gray-400"
                    rows={6}
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full py-5 bg-gradient-to-r from-purple-600 via-pink-600 to-orange-500 text-white rounded-2xl font-bold text-lg shadow-2xl hover:shadow-purple-500/50 disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center justify-center gap-3 group relative overflow-hidden"
                >
